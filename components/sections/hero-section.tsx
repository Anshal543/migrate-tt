...
export function HeroSection() {
  ...
  return (
    <section
      ...
      ref={heroRef}
    >
      <div className="absolute hidden md:block top-0 z-[0] h-full w-full opacity-10 bg-neutral-900/20 bg-[radial-gradient(ellipse_15%_60%_at_50%_10%,rgba(255,255,255,0.6),rgba(255,255,255,0))]"></div>
      <ParticleBackground />
